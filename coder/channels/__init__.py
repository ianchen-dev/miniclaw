...
from coder.channels.cli_channel import CLIChannel
from coder.channels.manager import ChannelManager
from coder.channels.schema import ChannelAccount, InboundMessage, build_session_key


# 条件导入：需要 httpx 的通道
try:
    from coder.channels.telegram_channel import TelegramChannel
except ImportError:
    TelegramChannel = None  # type: ignore

try:
    from coder.channels.feishu_channel import FeishuChannel
except ImportError:
