...
from coder.components.resilience.failure import FailoverReason, SimulatedFailure, classify_failure
from coder.components.resilience.profile import AuthProfile, ProfileManager
...
class ResilienceRunner:
    ...
    def run(
        ...
        """
        from coder.components.cli import print_resilience, print_warn, print_error
    ...
    def _run_attempt(
        ...
        from coder.components.cli import print_tool
    ...
    def _compact_history(
        ...
        Returns:
            list[dict]: 压缩后的消息列表
        """
        from coder.components.cli import print_resilience, print_warn
