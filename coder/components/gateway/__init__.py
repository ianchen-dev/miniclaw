...
Example:
    >>> from coder.components.gateway import AgentManager, AgentConfig, BindingTable, Binding
    >>>
    >>> # 创建 agent 管理器
    >>> mgr = AgentManager()
...
from coder.components.gateway.routing import (
    Binding,
    BindingTable,
    normalize_agent_id,
    DEFAULT_AGENT_ID,
)
from coder.components.gateway.agent_manager import (
    AgentConfig,
    AgentManager,
)
from coder.components.gateway.server import GatewayServer
from coder.components.gateway.event_loop import (
    get_event_loop,
    run_async,
    stop_event_loop,
)
