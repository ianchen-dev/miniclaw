...
```
 ...
 coder 目录代码行数统计
  ...
  │               文件路径               │ 行数 │
  ├──────────────────────────────────────┼──────┤
  │ coder/agent/loop.py                  │ 923  │
  ├──────────────────────────────────────┼──────┤
  │ coder/agent/**init**.py              │ 17   │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/base.py               │ 65   │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/cli_channel.py        │ 73   │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/feishu_channel.py     │ 277  │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/manager.py            │ 86   │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/schema.py             │ 113  │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/telegram_channel.py   │ 396  │
  ├──────────────────────────────────────┼──────┤
  │ coder/channels/**init**.py           │ 82   │
  ├──────────────────────────────────────┼──────┤
  │ coder/cli/**init**.py                │ 197  │
  ├──────────────────────────────────────┼──────┤
  │ coder/common/logger.py               │ 76   │
  ├──────────────────────────────────────┼──────┤
  │ coder/common/path.py                 │ 22   │
  ├──────────────────────────────────────┼──────┤
  │ coder/common/singleton.py            │ 29   │
  ├──────────────────────────────────────┼──────┤
  │ coder/common/time.py                 │ 6    │
  ├──────────────────────────────────────┼──────┤
  │ coder/common/**init**.py             │ 0    │
  ├──────────────────────────────────────┼──────┤
  │ coder/concurrency/queue.py           │ 339  │
  ├──────────────────────────────────────┼──────┤
  │ coder/concurrency/**init**.py        │ 50   │
  ├──────────────────────────────────────┼──────┤
  │ coder/delivery/queue.py              │ 419  │
  ├──────────────────────────────────────┼──────┤
  │ coder/delivery/runner.py             │ 201  │
  ├──────────────────────────────────────┼──────┤
  │ coder/delivery/**init**.py           │ 37   │
  ├──────────────────────────────────────┼──────┤
  │ coder/gateway/agent_manager.py       │ 216  │
  ├──────────────────────────────────────┼──────┤
  │ coder/gateway/event_loop.py          │ 86   │
  ├──────────────────────────────────────┼──────┤
  │ coder/gateway/routing.py             │ 181  │
  ├──────────────────────────────────────┼──────┤
  │ coder/gateway/server.py              │ 376  │
  ├──────────────────────────────────────┼──────┤
  │ coder/gateway/**init**.py            │ 68   │
  ├──────────────────────────────────────┼──────┤
  │ coder/intelligence/bootstrap.py      │ 149  │
  ├──────────────────────────────────────┼──────┤
  │ coder/intelligence/memory.py         │ 544  │
  ├──────────────────────────────────────┼──────┤
  │ coder/intelligence/prompt_builder.py │ 156  │
  ├──────────────────────────────────────┼──────┤
  │ coder/intelligence/skills.py         │ 221  │
  ├──────────────────────────────────────┼──────┤
  │ coder/intelligence/**init**.py       │ 56   │
  ├──────────────────────────────────────┼──────┤
  │ coder/main.py                        │ 9    │
  ├──────────────────────────────────────┼──────┤
  │ coder/prompts/**init**.py            │ 80   │
  ├──────────────────────────────────────┼──────┤
  │ coder/resilience/failure.py          │ 127  │
  ├──────────────────────────────────────┼──────┤
  │ coder/resilience/profile.py          │ 161  │
  ├──────────────────────────────────────┼──────┤
  │ coder/resilience/runner.py           │ 501  │
  ├──────────────────────────────────────┼──────┤
  │ coder/resilience/**init**.py         │ 69   │
  ├──────────────────────────────────────┼──────┤
  │ coder/scheduler/cron.py              │ 486  │
  ├──────────────────────────────────────┼──────┤
  │ coder/scheduler/heartbeat.py         │ 528  │
  ├──────────────────────────────────────┼──────┤
  │ coder/scheduler/**init**.py          │ 22   │
  ├──────────────────────────────────────┼──────┤
  │ coder/session/guard.py               │ 326  │
  ├──────────────────────────────────────┼──────┤
  │ coder/session/store.py               │ 296  │
  ├──────────────────────────────────────┼──────┤
  │ coder/session/**init**.py            │ 40   │
  ├──────────────────────────────────────┼──────┤
  │ coder/settings.py                    │ 80   │
  ├──────────────────────────────────────┼──────┤
  │ coder/tools/handlers.py              │ 330  │
  ├──────────────────────────────────────┼──────┤
  │ coder/tools/schema.py                │ 177  │
  ├──────────────────────────────────────┼──────┤
  │ coder/tools/**init**.py              │ 47   │
  └──────────────────────────────────────┴──────┘
  总计: 8,740 行代码
